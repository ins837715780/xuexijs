...
class _0x58ab1b {
  ...
  async getUserInfo() {
    ...
    try {
      ...
      _0xe5a92 = Object.assign({}, await this.taskApi(_0x221e8e));
  ...
  async getUserPoint() {
    ...
    try {
      ...
      _0x251d60 = Object.assign({}, await this.taskApi(_0x272a25));
  ...
  async getSignInfo() {
    ...
    try {
      ...
      _0x12d276 = Object.assign({}, await this.taskApi(_0x4c982f));
  ...
  async doSign() {
    ...
    try {
      ...
      _0x593334 = Object.assign({}, await this.taskApi(_0x5f0f53));
  ...
  async getTaskList() {
    ...
    try {
      ...
      _0x7e29b2 = Object.assign({}, await this.taskApi(_0x165aed));
  ...
  async getTaskReward() {
    ...
    try {
      ...
      _0x38e544 = Object.assign({}, await this.taskApi(_0x497152));
  ...
  async getPoints(_0x128601) {
    ...
    try {
      ...
      _0x2ce009 = Object.assign({}, await this.taskApi(_0x424780));
...
async function _0x1a86e1(_0x2be9a2 = 0) {
  ...
  try {
    ...
    let _0xc9e079 = null,
      _0xaa40db = await _0xbe49c4("get", _0x26376c);
    if (_0xaa40db.err) {
  ...
  return new class {
    ...
    send(_0x1fde03, _0x21540c, _0x53c818 = () => {}) {
      ...
      if (this.isSurge() || this.isLoon()) {
        ...
        if (_0x1fde03 == "get") {
          delete _0x8bd5e3.data;
        }
        $axios(_0x8bd5e3).then(_0x200f84 => {
          const {
              status: _0x158d8c,
              request: _0x2a12a9,
              headers: _0x430a28,
